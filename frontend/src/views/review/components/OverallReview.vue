      ...
      <div class="tw-flex tw-justify-end tw-w-full">
        <div class="tw-flex tw-flex-col tw-text-right tw-gap-y-1">
          <div class="tw-flex">
            ...
            <p
              class="tw-font-bold tw-text-white tw-bg-[#8B5CF6] tw-w-[2rem] tw-text-center tw-rounded"
            >
              195
            </p>
          </div>
          <div class="tw-flex">
            ...
            <p
              class="tw-font-bold tw-bg-purple-200 tw-w-[2rem] tw-text-center tw-rounded"
            >
              52
            </p>
          </div>
...
const overallReviewProgress = ref(27)
