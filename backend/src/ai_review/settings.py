"""
Django settings for ai_review project.
...
ASGI_APPLICATION = 'ai_review.asgi.application'
...
# CELERY_BROKER_URL = f"amqp://{env('RABBITMQ_DEFAULT_USER')}:{env('RABBITMQ_DEFAULT_PASS')}@ai_review_broker:5673//"
